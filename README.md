...
Основная команда для запуска всего цикла — `/rt_start`. Это slash-команда (workflow), которая проведет вас через все этапы.Работает на Antigravity IDE. Нужно загрузить PDF файл в корневую папку проекта.
...
### Phase 2: Generator Construction 
